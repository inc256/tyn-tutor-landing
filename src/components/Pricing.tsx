        ...
        <div className="container py-24 md:py-32">
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-start">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="rounded-[2rem] border border-border/60 bg-card/95 p-8 shadow-elevated backdrop-blur-xl"
            >
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div className="space-y-3">
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] text-primary">Why choose Xplainfy</p>
                  <h3 className="font-display text-3xl font-bold">Plans tailored to every stage of decision-making.</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    From early exploration to final deliverables, every tier gives you the structure, evidence, and output tools needed to move faster with confidence.
                  </p>
                </div>
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-3xl border border-border/70 bg-background/90 p-4 text-sm text-muted-foreground">
                    <p className="font-semibold text-foreground">Focused research</p>
                    <p className="mt-2">Find the signal in your sources and build stronger insights.</p>
                  </div>
                  <div className="rounded-3xl border border-border/70 bg-background/90 p-4 text-sm text-muted-foreground">
                    <p className="font-semibold text-foreground">Actionable reports</p>
                    <p className="mt-2">Turn reasoning into polished summaries your team can share.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="rounded-[2rem] border border-border/70 bg-card p-8 shadow-soft"
            >
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] text-primary">Need help choosing?</p>
                  <p className="mt-2 text-muted-foreground text-sm">Compare plans by usage, speed, and collaboration needs.</p>
                </div>
                <Badge className="rounded-full bg-primary/10 text-primary border border-primary/20 px-3 py-2 text-xs">
                  4 options
                </Badge>
              </div>
              ...
              <div className="mt-8 grid gap-4">
                {plans.map((plan) => (
                  <div key={plan.name} className="group rounded-3xl border border-border/70 bg-background/90 p-5 transition hover:border-primary/50 hover:shadow-elevated">
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div className={`grid place-items-center h-12 w-12 rounded-3xl bg-gradient-to-br ${plan.color} text-white shadow-glow`}>
                          {plan.icon}
                        </div>
                        <div>
