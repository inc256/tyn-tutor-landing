            ...
            >
              ...
              <div className="space-y-12">
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="mt-4 text-sm italic">Note: We do not intentionally collect precise location information or IP addresses for profiling purposes.</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-4 text-muted-foreground leading-relaxed">To make a request, contact us using the email below.</p>
                </motion.div>
