            ...
            <div>
              ...
              >
                <div className="text-center mb-16">
                  ...
                  <h1 className="mt-3 font-display text-4xl md:text-5xl font-bold">Xplainfy Refund Policy</h1>
              ...
              <div className="space-y-12">
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">2. Credit Purchases (Basic Plan)</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Credits purchased through Xplainfy are non-refundable once they have been added to your account.
                  </p>
                  <p className="text-muted-foreground leading-relaxed mb-4">Refunds may only be considered if:</p>
                  <ul className="text-muted-foreground leading-relaxed space-y-2 ml-6 list-disc mb-4">
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">3. Subscription Plans (Pro and Ultra)</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">Refunds for subscription payments may be granted only if:</p>
                  <ul className="text-muted-foreground leading-relaxed space-y-2 ml-6 list-disc mb-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">No refunds will be issued for:</p>
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">4. Free Plan</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">5. Abuse Prevention</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">6. Service Availability</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">7. Chargebacks</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                >
                  ...
                  <div className="bg-muted/50 rounded-lg p-4">
                    <p className="text-foreground font-medium">Email: lunainc256@mail.com</p>
                  </div>
                  <p className="text-muted-foreground leading-relaxed mt-4">Please include:</p>
                  <ul className="text-muted-foreground leading-relaxed space-y-2 ml-6 list-disc mt-2">
                ...
                <motion.div
                  ...
                  className="rounded-3xl bg-card border border-border/70 shadow-soft p-8"
                >
                  <h2 className="font-display text-2xl font-semibold mb-4">9. Policy Updates</h2>
                  <p className="text-muted-foreground leading-relaxed">
